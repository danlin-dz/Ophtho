...
# ---------------------------------------------------------------- config ----
from phonetics import PHON  # noqa: F401  (used by build.py)
...
STAGES = [
    ...
    dict(id="acuity",   num="02", title="Vision",        note=None,  ids=["s02-01","s02-02","s02-03","s02-04","s02-05","s02-06","s02-07","s02-08"], diplopiaAfter="s02-07"),
...
EN = {
 "s01-01":"I am your eye doctor.",
 "s01-02":"Please sit here.",
 "s01-03":"Please take off your glasses.",
 "s01-04":"Does it hurt? Point to where.",
 "s02-01":"Put your glasses on.",
 "s02-02":"Please read the smallest line you can see.",
 "s02-03":"How many fingers?",
 "s02-04":"Can you see this?",
 "s02-05":"Tell me if you see the light move.",
 "s02-06":"Look at my nose.",
 "s02-07":"Do you see two of me?",
 "s02-08":"Is it worse looking this way?",
 "s03-01":"Look at my finger. Do not move your head.",
 "s03-02":"Look up.",
 "s03-03":"Look down.",
 "s03-04":"Look left.",
 "s03-05":"Look right.",
 "s03-06":"Look straight ahead.",
 ...
 "s05-01":"Chin on the rest, forehead against the bar.",
 "s05-02":"Open your eyes.",
...
QUICK = ["s03-06","s02-06","s02-03","s03-01","s02-07",
         "s03-02","s03-04","s03-05","s03-03","s05-02","s04-07"]
...
# --------------------------------------------------------------- MANDARIN ---
ZH = {
 "s01-01":("我是您的眼科医生。","我是您的眼科醫生。","Wǒ shì nín de yǎnkē yīshēng."),
 ...
 "s02-01":("请把眼镜戴上。","請把眼鏡戴上。","Qǐng bǎ yǎnjìng dài shàng."),
 "s02-02":("请念您能看到的最小的一行。","請念您能看到的最小的一行。","Qǐng niàn nín néng kàndào de zuì xiǎo de yì háng."),
 "s02-03":("几根手指？","幾根手指？","Jǐ gēn shǒuzhǐ?"),
 "s02-04":("看得见吗？","看得見嗎？","Kàn de jiàn ma?"),
 "s02-05":("看到光移动请告诉我。","看到光移動請告訴我。","Kàndào guāng yídòng qǐng gàosu wǒ."),
 "s02-06":("请看我的鼻子。","請看我的鼻子。","Qǐng kàn wǒ de bízi."),
 "s02-07":("您看到两个我吗？","您看到兩個我嗎？","Nín kàndào liǎng ge wǒ ma?"),
 "s02-08":("看这个方向更严重吗？","看這個方向更嚴重嗎？","Kàn zhège fāngxiàng gèng yánzhòng ma?"),
 ...
 "s03-06":("请看正前方。","請看正前方。","Qǐng kàn zhèng qiánfāng."),
 ...
 "s05-01":("下巴放在这里，额头靠着这里。","下巴放在這裡，額頭靠著這裡。","Xiàba fàng zài zhèlǐ, étóu kàozhe zhèlǐ."),
 "s05-02":("请睁开眼睛。","請睜開眼睛。","Qǐng zhēngkāi yǎnjīng."),
...
# -------------------------------------------------------------- CANTONESE ---
YUE = {
 "s01-01":("我係你嘅眼科醫生。","Ngo5 hai6 nei5 ge3 ngaan5fo1 ji1sang1."),
 ...
 "s02-01":("請戴返眼鏡。","Cing2 daai3faan1 ngaan5geng2."),
 "s02-02":("請讀你睇到最細嗰行。","Cing2 duk6 nei5 tai2dou2 zeoi3 sai3 go2 hong4."),
 "s02-03":("幾多隻手指？","Gei2do1 zek3 sau2zi2?"),
 "s02-04":("睇唔睇到？","Tai2 m4 tai2dou2?"),
 "s02-05":("見到光郁請話我知。","Gin3dou2 gwong1 juk1 cing2 waa6 ngo5 zi1."),
 "s02-06":("望住我個鼻。","Mong6zyu6 ngo5 go3 bei6."),
 "s02-07":("你係咪見到兩個我？","Nei5 hai6mai6 gin3dou2 loeng5 go3 ngo5?"),
 "s02-08":("望呢邊會唔會嚴重啲？","Mong6 ni1bin1 wui5 m4 wui5 jim4zung6 di1?"),
 ...
 "s03-06":("望正前面。","Mong6 zeng3 cin4min6."),
 ...
 "s05-01":("下巴放喺呢度，額頭貼住呢度。","Haa6baa1 fong3 hai2 ni1dou6, ngaak6tau4 tip3zyu6 ni1dou6."),
 "s05-02":("請擘大對眼。","Cing2 maak3 daai6 deoi3 ngaan5."),
...
# ---------------------------------------------------------------- PUNJABI ---
PA = {
 "s01-01":("ਮੈਂ ਤੁਹਾਡਾ ਅੱਖਾਂ ਦਾ ਡਾਕਟਰ ਹਾਂ।","Main tuhada akhan da daktar haan."),
 ...
 "s02-01":("ਕਿਰਪਾ ਕਰਕੇ ਐਨਕ ਲਗਾਓ।","Kirpa karke ainak lagao."),
 "s02-02":("ਜੋ ਸਭ ਤੋਂ ਛੋਟੀ ਲਾਈਨ ਦਿਸਦੀ ਹੈ ਉਹ ਪੜ੍ਹੋ।","Jo sabh ton chhoti line disdi hai oh parho."),
 "s02-03":("ਕਿੰਨੀਆਂ ਉਂਗਲਾਂ?","Kinnian unglan?"),
 "s02-04":("ਕੀ ਇਹ ਦਿਸਦਾ ਹੈ?","Ki ih disda hai?"),
 "s02-05":("ਜੇ ਰੌਸ਼ਨੀ ਹਿਲਦੀ ਦਿਸੇ ਤਾਂ ਦੱਸੋ।","Je raushni hildi dise tan dasso."),
 "s02-06":("ਮੇਰੇ ਨੱਕ ਵੱਲ ਦੇਖੋ।","Mere nakk vall dekho."),
 "s02-07":("ਕੀ ਤੁਹਾਨੂੰ ਦੋ ਦਿਸਦੇ ਹਨ?","Ki tuhanu do disde han?"),
 "s02-08":("ਇਸ ਪਾਸੇ ਦੇਖਣ ਤੇ ਵੱਧ ਹੁੰਦਾ ਹੈ?","Is pase dekhan te vadh hunda hai?"),
 ...
 "s03-06":("ਸਿੱਧਾ ਸਾਹਮਣੇ ਦੇਖੋ।","Siddha sahmane dekho."),
 "s04-01":("ਕੀ ਤੁਹਾਨੂੰ ਕਿਸੇ ਦਵਾਈ ਤੋਂ ਐਲਰਜੀ ਹੈ?","Ki tuhanu kise davai ton allergy hai?"),
 "s04-02":("ਹੁਣ ਤੁਹਾਡੀ ਅੱਖ ਵਿੱਚ ਬੂੰਦਾਂ ਪਾਉਣੀਆਂ ਹਨ।","Hun tuhadi akh vich boondan paunian han."),
 ...
 "s05-01":("ਠੋਡੀ ਇੱਥੇ ਰੱਖੋ, ਮੱਥਾ ਇਸ ਪੱਟੀ ਨਾਲ ਲਗਾਓ।","Thodi ithe rakho, mattha is patti nal lagao."),
 "s05-02":("ਅੱਖਾਂ ਖੋਲ੍ਹੋ।","Akhan kholho."),
 ...
 "s05-06":("ਹੁਣ ਤੁਹਾਡੀ ਪਲਕ ਨੂੰ ਛੂਹਣਾ ਹੈ।","Hun tuhadi palak nu chhuhna hai."),
 "s05-07":("ਲਗਭਗ ਹੋ ਗਿਆ।","Lagbhag ho gia."),
 "s06-01":("ਜਾਂਚ ਪੂਰੀ ਹੋ ਗਈ। ਧੰਨਵਾਦ।","Janch puri ho gai. Dhanvaad."),
 "s06-02":("ਨਤੀਜੇ ਸਮਝਾਉਣ ਲਈ ਦੁਭਾਸ਼ੀਏ ਦੀ ਵਰਤੋਂ ਕੀਤੀ ਜਾਵੇਗੀ।","Natije samjhaun lai dubhashiye di varton kiti javegi."),
}
...
# ------------------------------------------------------------------ FARSI ---
FA = {
 "s01-01":("من چشم‌پزشک شما هستم.","Man cheshm-pezeshk-e shomâ hastam."),
 ...
 "s02-01":("لطفاً عینک خود را بزنید.","Lotfan eynak-e khod râ bezanid."),
 "s02-02":("کوچک‌ترین خطی که می‌بینید بخوانید.","Kuchaktarin khatti ke mibinid bekhânid."),
 "s02-03":("چند انگشت؟","Chand angosht?"),
 "s02-04":("این را می‌بینید؟","In râ mibinid?"),
 "s02-05":("اگر نور حرکت کرد به من بگویید.","Agar nur harekat kard be man beguyid."),
 "s02-06":("به بینی من نگاه کنید.","Be bini-ye man negâh konid."),
 "s02-07":("آیا مرا دوتا می‌بینید؟","Âyâ marâ do tâ mibinid?"),
 "s02-08":("وقتی به این طرف نگاه می‌کنید بدتر است؟","Vaqti be in taraf negâh mikonid badtar ast?"),
 ...
 "s03-06":("مستقیم به جلو نگاه کنید.","Mostaqim be jelow negâh konid."),
 ...
 "s05-01":("چانه را اینجا بگذارید و پیشانی را به این میله تکیه دهید.","Châne râ injâ bogzârid va pishâni râ be in mile tekye dahid."),
 "s05-02":("چشمانتان را باز کنید.","Cheshmânetân râ bâz konid."),
...
# ----------------------------------------------------------------- ARABIC ---
AR = {
 "s01-01":("أنا طبيب العيون.","Anâ tabîb al-'uyûn."),
 ...
 "s02-01":("من فضلك ضع نظارتك.","Min fadlik da' nazzâratak."),
 "s02-02":("اقرأ أصغر سطر تراه.","Iqra' asghar satr tarâh."),
 "s02-03":("كم إصبعاً؟","Kam isba'an?"),
 "s02-04":("هل ترى هذا؟","Hal tarâ hâdhâ?"),
 "s02-05":("أخبرني إذا رأيت الضوء يتحرك.","Akhbirnî idhâ ra'ayta ad-daw' yataharrak."),
 "s02-06":("انظر إلى أنفي.","Unzur ilâ anfî."),
 "s02-07":("هل ترانِي اثنين؟","Hal tarânî ithnayn?"),
 "s02-08":("هل يزداد سوءاً عند النظر هكذا؟","Hal yazdâd sû'an 'inda an-nazar hâkadhâ?"),
 ...
 "s03-06":("انظر إلى الأمام مباشرة.","Unzur ilâ al-amâm mubâsharatan."),
 ...
 "s05-01":("ضع ذقنك هنا وألصق جبهتك بهذا الشريط.","Da' dhaqnak hunâ wa-alsiq jabhatak bi-hâdhâ ash-sharît."),
 "s05-02":("افتح عينيك.","Iftah 'aynayk."),
...
# ----------------------------------------------------------------- KOREAN ---
KO = {
 "s01-01":("저는 안과 의사입니다.","Jeoneun angwa uisaimnida."),
 ...
 "s02-01":("안경을 쓰세요.","Angyeongeul sseuseyo."),
 "s02-02":("보이는 가장 작은 줄을 읽어 주세요.","Boineun gajang jageun jureul ilgeo juseyo."),
 "s02-03":("손가락 몇 개예요?","Songarak myeot gaeyeyo?"),
 "s02-04":("이게 보이세요?","Ige boiseyo?"),
 "s02-05":("빛이 움직이면 말씀해 주세요.","Bichi umjigimyeon malsseumhae juseyo."),
 "s02-06":("제 코를 보세요.","Je koreul boseyo."),
 "s02-07":("제가 두 명으로 보이세요?","Jega du myeongeuro boiseyo?"),
 "s02-08":("이쪽을 볼 때 더 심한가요?","Ijjogeul bol ttae deo simhangayo?"),
 ...
 "s03-06":("정면을 보세요.","Jeongmyeoneul boseyo."),
 ...
 "s05-01":("턱을 여기에 대고 이마를 여기에 붙이세요.","Teogeul yeogie daego imareul yeogie buchiseyo."),
 "s05-02":("눈을 뜨세요.","Nuneul tteuseyo."),
...
JA = {
 ...
 "s02-01":("眼鏡をかけてください。","Megane o kakete kudasai."),
 "s02-02":("見える一番小さい行を読んでください。","Mieru ichiban chiisai gyō o yonde kudasai."),
 "s02-03":("指は何本ですか？","Yubi wa nanbon desu ka?"),
 "s02-04":("これが見えますか？","Kore ga miemasu ka?"),
 "s02-05":("光が動いたら教えてください。","Hikari ga ugoitara oshiete kudasai."),
 "s02-06":("私の鼻を見てください。","Watashi no hana o mite kudasai."),
 "s02-07":("私が二人に見えますか？","Watashi ga futari ni miemasu ka?"),
 "s02-08":("こちらを見るとひどくなりますか？","Kochira o miru to hidoku narimasu ka?"),
 ...
 "s03-06":("まっすぐ前を見てください。","Massugu mae o mite kudasai."),
 ...
 "s05-01":("顎をここに乗せ、額をここにつけてください。","Ago o koko ni nose, hitai o koko ni tsukete kudasai."),
 "s05-02":("目を開けてください。","Me o akete kudasai."),
...
# ------------------------------------------------------------- VIETNAMESE ---
VI = {
 "s01-01":("Tôi là bác sĩ mắt của ông/bà.",""),
 "s01-02":("Xin mời ngồi đây.",""),
 "s01-03":("Xin tháo kính ra.",""),
 "s01-04":("Có đau không? Xin chỉ chỗ đau.",""),
 "s02-01":("Xin đeo kính vào.",""),
 "s02-02":("Xin đọc dòng nhỏ nhất mà ông/bà nhìn thấy.",""),
 "s02-03":("Mấy ngón tay?",""),
 "s02-04":("Ông/bà có thấy cái này không?",""),
 "s02-05":("Nếu thấy ánh sáng di chuyển, xin cho tôi biết.",""),
 "s02-06":("Xin nhìn vào mũi tôi.",""),
 "s02-07":("Ông/bà có thấy hai người tôi không?",""),
 "s02-08":("Nhìn về hướng này có nặng hơn không?",""),
 "s03-01":("Xin nhìn ngón tay tôi. Đừng quay đầu.",""),
 "s03-02":("Nhìn lên.",""),
 "s03-03":("Nhìn xuống.",""),
 "s03-04":("Nhìn sang trái.",""),
 "s03-05":("Nhìn sang phải.",""),
 "s03-06":("Nhìn thẳng phía trước.",""),
 ...
 "s04-08":("Đừng dụi mắt.",""),
 "s05-01":("Đặt cằm vào đây và áp trán vào thanh này.",""),
 "s05-02":("Xin mở mắt ra.",""),
...
# ----------------------------------------------------------------- TAGALOG --
TL = {
 "s01-01":("Ako po ang inyong doktor sa mata.",""),
 "s01-02":("Maupo po kayo rito.",""),
 "s01-03":("Pakitanggal po ang inyong salamin.",""),
 "s01-04":("Masakit po ba? Ituro po ninyo kung saan.",""),
 "s02-01":("Isuot po ninyo ang inyong salamin.",""),
 "s02-02":("Pakibasa po ang pinakamaliit na linyang nakikita ninyo.",""),
 "s02-03":("Ilang daliri po?",""),
 "s02-04":("Nakikita po ba ninyo ito?",""),
 "s02-05":("Sabihin po ninyo kung gumagalaw ang ilaw.",""),
 "s02-06":("Tingnan po ninyo ang ilong ko.",""),
 "s02-07":("Nakikita po ba ninyo akong dalawa?",""),
 "s02-08":("Mas malala po ba kapag tumitingin sa ganitong direksyon?",""),
 ...
 "s05-01":("Ipatong po ang baba dito at idikit ang noo sa bar.",""),
 "s05-02":("Imulat po ninyo ang mga mata.",""),
