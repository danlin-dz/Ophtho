...
const STAGES = [
  {
    ...
    items:[
      {id:"s01-01", en:"I'm the doctor, I'm going to check your eyes.", x:"Doktor po ako, titingnan ko ang inyong mga mata.", p:"dok-tor po ah-ko, tee-ting-nan ko ang in-yong ma-nga ma-ta"},
