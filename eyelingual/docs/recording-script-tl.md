...
|---|---|---|---|
| `s01-01` | `s01-01.m4a` | Doktor po ako, titingnan ko ang inyong mga mata. | I'm the doctor, I'm going to check your eyes. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s02-01` | `s02-01.m4a` | Pakibasa po ang pinakamaliit na linyang nakikita ninyo. | Please read the smallest line you can see. |
| `s02-02` | `s02-02.m4a` | Ilang daliri po? | How many fingers? |
| `s02-03` | `s02-03.m4a` | Nakikita po ba ninyo ito? | Can you see this? |
| `s02-04` | `s02-04.m4a` | Sabihin po ninyo kung gumagalaw ang ilaw. | Tell me if you see the light move. |
| `s02-05` | `s02-05.m4a` | Tingnan po ninyo ang ilong ko. | Look at my nose. |
| `s02-06` | `s02-06.m4a` | Nakikita po ba ninyo akong dalawa? | Do you see two of me? |
| `s02-07` | `s02-07.m4a` | Mas malala po ba kapag tumitingin sa ganitong direksyon? | Is it worse looking this way? |

## 03 · Eye movements

| ID | File | Say this | English |
|---|---|---|---|
| `s03-01` | `s03-01.m4a` | Tingnan po ninyo ang daliri ko. Huwag pong igalaw ang ulo. | Look at my finger. Don't move your head. |
...
| `s03-06` | `s03-06.m4a` | Tumingin po sa malayo. | Look far away. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s05-01` | `s05-01.m4a` | Ipatong po ang baba dito. | Chin on the rest. |
| `s05-02` | `s05-02.m4a` | Idikit po ang noo sa bar na ito. | Forehead against the bar. |
