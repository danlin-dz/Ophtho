...
|---|---|---|---|
| `s01-01` | `s01-01.m4a` | Tôi là bác sĩ mắt của ông/bà. | I am your eye doctor. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s02-01` | `s02-01.m4a` | Xin đeo kính vào. | Put your glasses on. |
| `s02-02` | `s02-02.m4a` | Xin đọc dòng nhỏ nhất mà ông/bà nhìn thấy. | Please read the smallest line you can see. |
| `s02-03` | `s02-03.m4a` | Mấy ngón tay? | How many fingers? |
| `s02-04` | `s02-04.m4a` | Ông/bà có thấy cái này không? | Can you see this? |
| `s02-05` | `s02-05.m4a` | Nếu thấy ánh sáng di chuyển, xin cho tôi biết. | Tell me if you see the light move. |
| `s02-06` | `s02-06.m4a` | Xin nhìn vào mũi tôi. | Look at my nose. |
| `s02-07` | `s02-07.m4a` | Ông/bà có thấy hai người tôi không? | Do you see two of me? |
| `s02-08` | `s02-08.m4a` | Nhìn về hướng này có nặng hơn không? | Is it worse looking this way? |

## 03 · Eye movements

| ID | File | Say this | English |
|---|---|---|---|
| `s03-01` | `s03-01.m4a` | Xin nhìn ngón tay tôi. Đừng quay đầu. | Look at my finger. Do not move your head. |
...
| `s03-06` | `s03-06.m4a` | Nhìn thẳng phía trước. | Look straight ahead. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s05-01` | `s05-01.m4a` | Đặt cằm vào đây và áp trán vào thanh này. | Chin on the rest, forehead against the bar. |
| `s05-02` | `s05-02.m4a` | Xin mở mắt ra. | Open your eyes. |
