...
|---|---|---|---|
| `s01-01` | `s01-01.m4a` | 我是您的眼科医生。 | I am your eye doctor. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s02-01` | `s02-01.m4a` | 请把眼镜戴上。 | Put your glasses on. |
| `s02-02` | `s02-02.m4a` | 请念您能看到的最小的一行。 | Please read the smallest line you can see. |
| `s02-03` | `s02-03.m4a` | 几根手指？ | How many fingers? |
| `s02-04` | `s02-04.m4a` | 看得见吗？ | Can you see this? |
| `s02-05` | `s02-05.m4a` | 看到光移动请告诉我。 | Tell me if you see the light move. |
| `s02-06` | `s02-06.m4a` | 请看我的鼻子。 | Look at my nose. |
| `s02-07` | `s02-07.m4a` | 您看到两个我吗？ | Do you see two of me? |
| `s02-08` | `s02-08.m4a` | 看这个方向更严重吗？ | Is it worse looking this way? |

## 03 · Eye movements

| ID | File | Say this | English |
|---|---|---|---|
| `s03-01` | `s03-01.m4a` | 请看我的手指，头不要动。 | Look at my finger. Do not move your head. |
...
| `s03-06` | `s03-06.m4a` | 请看正前方。 | Look straight ahead. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s05-01` | `s05-01.m4a` | 下巴放在这里，额头靠着这里。 | Chin on the rest, forehead against the bar. |
| `s05-02` | `s05-02.m4a` | 请睁开眼睛。 | Open your eyes. |
