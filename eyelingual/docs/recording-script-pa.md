...
| ID | File | Say this | English |
|---|---|---|---|
| `s02-01` | `s02-01.m4a` | ਜੋ ਸਭ ਤੋਂ ਛੋਟੀ ਲਾਈਨ ਦਿਸਦੀ ਹੈ ਉਹ ਪੜ੍ਹੋ। | Please read the smallest line you can see. |
| `s02-02` | `s02-02.m4a` | ਕਿੰਨੀਆਂ ਉਂਗਲਾਂ? | How many fingers? |
| `s02-03` | `s02-03.m4a` | ਕੀ ਇਹ ਦਿਸਦਾ ਹੈ? | Can you see this? |
| `s02-04` | `s02-04.m4a` | ਜੇ ਰੌਸ਼ਨੀ ਹਿਲਦੀ ਦਿਸੇ ਤਾਂ ਦੱਸੋ। | Tell me if you see the light move. |
| `s02-05` | `s02-05.m4a` | ਮੇਰੇ ਨੱਕ ਵੱਲ ਦੇਖੋ। | Look at my nose. |
| `s02-06` | `s02-06.m4a` | ਕੀ ਤੁਹਾਨੂੰ ਮੈਂ ਦੋ ਦਿਸਦਾ ਹਾਂ? | Do you see two of me? |
| `s02-07` | `s02-07.m4a` | ਇਸ ਪਾਸੇ ਦੇਖਣ ਤੇ ਵੱਧ ਹੁੰਦਾ ਹੈ? | Is it worse looking this way? |

## 03 · Eye movements

| ID | File | Say this | English |
|---|---|---|---|
| `s03-01` | `s03-01.m4a` | ਮੇਰੀ ਉਂਗਲ ਵੱਲ ਦੇਖੋ। ਸਿਰ ਨਾ ਹਿਲਾਓ। | Look at my finger. Don't move your head. |
...
| `s03-06` | `s03-06.m4a` | ਦੂਰ ਦੇਖੋ। | Look far away. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s05-01` | `s05-01.m4a` | ਠੋਡੀ ਇੱਥੇ ਰੱਖੋ। | Chin on the rest. |
| `s05-02` | `s05-02.m4a` | ਮੱਥਾ ਇਸ ਪੱਟੀ ਨਾਲ ਲਗਾਓ। | Forehead against the bar. |
