...
| ID | File | Say this | English |
|---|---|---|---|
| `s02-01` | `s02-01.m4a` | کوچک‌ترین خطی که می‌بینید بخوانید. | Please read the smallest line you can see. |
| `s02-02` | `s02-02.m4a` | چند انگشت؟ | How many fingers? |
| `s02-03` | `s02-03.m4a` | این را می‌بینید؟ | Can you see this? |
| `s02-04` | `s02-04.m4a` | اگر نور حرکت کرد به من بگویید. | Tell me if you see the light move. |
| `s02-05` | `s02-05.m4a` | به بینی من نگاه کنید. | Look at my nose. |
| `s02-06` | `s02-06.m4a` | آیا مرا دوتا می‌بینید؟ | Do you see two of me? |
| `s02-07` | `s02-07.m4a` | وقتی به این طرف نگاه می‌کنید بدتر است؟ | Is it worse looking this way? |

## 03 · Eye movements

| ID | File | Say this | English |
|---|---|---|---|
| `s03-01` | `s03-01.m4a` | به انگشت من نگاه کنید. سرتان را تکان ندهید. | Look at my finger. Don't move your head. |
...
| `s03-06` | `s03-06.m4a` | به دور نگاه کنید. | Look far away. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s05-01` | `s05-01.m4a` | چانه را اینجا بگذارید. | Chin on the rest. |
| `s05-02` | `s05-02.m4a` | پیشانی را به این میله تکیه دهید. | Forehead against the bar. |
