...
|---|---|---|---|
| `s01-01` | `s01-01.m4a` | أنا طبيب العيون. | I am your eye doctor. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s02-01` | `s02-01.m4a` | من فضلك ضع نظارتك. | Put your glasses on. |
| `s02-02` | `s02-02.m4a` | اقرأ أصغر سطر تراه. | Please read the smallest line you can see. |
| `s02-03` | `s02-03.m4a` | كم إصبعاً؟ | How many fingers? |
| `s02-04` | `s02-04.m4a` | هل ترى هذا؟ | Can you see this? |
| `s02-05` | `s02-05.m4a` | أخبرني إذا رأيت الضوء يتحرك. | Tell me if you see the light move. |
| `s02-06` | `s02-06.m4a` | انظر إلى أنفي. | Look at my nose. |
| `s02-07` | `s02-07.m4a` | هل ترانِي اثنين؟ | Do you see two of me? |
| `s02-08` | `s02-08.m4a` | هل يزداد سوءاً عند النظر هكذا؟ | Is it worse looking this way? |

## 03 · Eye movements

| ID | File | Say this | English |
|---|---|---|---|
| `s03-01` | `s03-01.m4a` | انظر إلى إصبعي. لا تحرك رأسك. | Look at my finger. Do not move your head. |
...
| `s03-06` | `s03-06.m4a` | انظر إلى الأمام مباشرة. | Look straight ahead. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s05-01` | `s05-01.m4a` | ضع ذقنك هنا وألصق جبهتك بهذا الشريط. | Chin on the rest, forehead against the bar. |
| `s05-02` | `s05-02.m4a` | افتح عينيك. | Open your eyes. |
