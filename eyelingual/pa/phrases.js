...
const STAGES = [
  {
    ...
    items:[
      {id:"s01-01", en:"I'm the doctor, I'm going to check your eyes.", x:"ਮੈਂ ਡਾਕਟਰ ਹਾਂ, ਮੈਂ ਤੁਹਾਡੀਆਂ ਅੱਖਾਂ ਦੀ ਜਾਂਚ ਕਰਾਂਗਾ।", p:"mane dahk-tar haan, mane tu-hah-dee-yan uh-khan dee jaanch kuh-ran-ga"},
  ...
  },
  {
    ...
    items:[
      ...
      {id:"s02-07", en:"Do you see two of me?", x:"ਕੀ ਤੁਹਾਨੂੰ ਮੈਂ ਦੋ ਦਿਸਦਾ ਹਾਂ?", p:"kee tu-hah-noo mane doe dis-dah haan?"},
  ...
  },
  {
    ...
    items:[
      ...
      {id:"s04-02", en:"I'm going to put drops in your eye.", x:"ਮੈਂ ਤੁਹਾਡੀ ਅੱਖ ਵਿੱਚ ਬੂੰਦਾਂ ਪਾਵਾਂਗਾ।", p:"mane tu-hah-dee ukh vich boon-daan puh-vaan-ga"},
  ...
  },
  {
    ...
    items:[
      ...
      {id:"s05-06", en:"I'm going to touch your eyelid.", x:"ਮੈਂ ਤੁਹਾਡੀ ਪਲਕ ਨੂੰ ਛੂਹਾਂਗਾ।", p:"mane tu-hah-dee puh-luck noo chu-haan-ga"},
  ...
  },
  {
    ...
    items:[
      ...
      {id:"s06-02", en:"We will use an interpreter to explain the results.", x:"ਅਸੀਂ ਨਤੀਜੇ ਸਮਝਾਉਣ ਲਈ ਦੁਭਾਸ਼ੀਏ ਦੀ ਵਰਤੋਂ ਕਰਾਂਗੇ।", p:"uh-seen nuh-tee-jay sum-jhown lye du-bhah-shee-yay dee var-tone kuh-raan-gay"}
    ]
  }
];
