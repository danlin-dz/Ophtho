...
|---|---|---|---|
| `s01-01` | `s01-01.m4a` | 医師です。目を診察します。 | I'm the doctor, I'm going to check your eyes. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s02-01` | `s02-01.m4a` | 見える一番小さい行を読んでください。 | Please read the smallest line you can see. |
| `s02-02` | `s02-02.m4a` | 指は何本ですか？ | How many fingers? |
| `s02-03` | `s02-03.m4a` | これが見えますか？ | Can you see this? |
| `s02-04` | `s02-04.m4a` | 光が動いたら教えてください。 | Tell me if you see the light move. |
| `s02-05` | `s02-05.m4a` | 私の鼻を見てください。 | Look at my nose. |
| `s02-06` | `s02-06.m4a` | 私が二人に見えますか？ | Do you see two of me? |
| `s02-07` | `s02-07.m4a` | こちらを見るとひどくなりますか？ | Is it worse looking this way? |

## 03 · Eye movements

| ID | File | Say this | English |
|---|---|---|---|
| `s03-01` | `s03-01.m4a` | 私の指を見てください。頭は動かさないでください。 | Look at my finger. Don't move your head. |
...
| `s03-06` | `s03-06.m4a` | 遠くを見てください。 | Look far away. |
...
| ID | File | Say this | English |
|---|---|---|---|
| `s05-01` | `s05-01.m4a` | 顎をここに乗せてください。 | Chin on the rest. |
| `s05-02` | `s05-02.m4a` | 額をここにつけてください。 | Forehead against the bar. |
